...
const Deity DEITIES[] = {
    ...
    { "Heironeous", "god of chivalry and valour",
      "Greyhawk", "LG",
    ...
    { "Kiri-Jolith", "god of honour and war",
      "Dragonlance", "LG",
      "War", "Bison's horns" },
    ...
    { "Dol Arrah", "goddess of sunlight and honour",
      "Eberron", "LG",
    ...
    { "The Traveller", "deity of chaos and change",
      "Eberron", "CN",
      "Knowledge, Trickery", "Four crossed, forking paths" },
    { "The Blood of Vol", "belief in divinity of blood and undeath",
      "Eberron", "LE",
      "Death, Life", "Stylised red teardrop" },
    { "The Silver Flame", "devotion to good",
      "Eberron", "LG",
    ...
    { "Imhotep", "god of craft and medicine",
      "Egyptian", "NG",
    ...
    { "Moradin", "dwarf deity of creation",
      "Nonhuman", "LG",
      "Knowledge", "Hammer and anvil" },
    { "Garl Glittergold", "gnome deity of trickery and wiles",
      "Nonhuman", "LG",
      "Trickery", "Gold nugget" },
    { "Yondalla", "halfling deity of fertility and protection",
      "Nonhuman", "LG",
      "Life", "Cornucopia on a shield" },
    { "Gruumsh", "orc deity of storms and war",
      "Nonhuman", "CE",
      "Tempest, War", "Unblinking eye" },
    { "Bahamut", "dragon deity of good dragonkind",
      "Nonhuman", "LG",
      "Life, War", "Dragon's head in profile" },
    { "Tiamat", "dragon deity of evil dragonkind",
      "Nonhuman", "LE",
      "Trickery", "Dragon head with five claw marks" },
    { "Lolth", "drow deity of spiders",
      "Nonhuman", "CE",
      "Trickery", "Spider" },
    { "Sehanine Moonbow", "elf deity of the moon",
      "Nonhuman", "CG",
      "Knowledge", "Crescent moon" },
    { "Sekolah", "sahuagin deity of the hunt",
      "Nonhuman", "LE",
      "Nature, Tempest", "Shark" },
    { "Semuanya", "lizardfolk deity of survival",
      "Nonhuman", "N",
      "Life", "Egg" },
    { "Skerrit", "centaur and satyr deity of nature",
      "Nonhuman", "N",
      "Nature", "Oak growing from acorn" },
    { "Surtur", "giant deity of craft and fire",
      "Nonhuman", "LE",
      "Knowledge, War", "Flaming sword" },
    { "Thryn", "giant deity of frost and strength",
      "Nonhuman", "CE",
      "War", "White double-bladed axe" },
    { "Grolantor", "hill giant deity of war",
      "Nonhuman", "CE",
      "War", "Wooden club" },
    { "Hruggek", "bugbear deity of violence",
      "Nonhuman", "CE",
      "War", "Morningstar" },
    { "Maglubiyet", "goblinoid deity of war",
      "Nonhuman", "LE",
      "War", "Bloody axe" },
    { "Kurtulmak", "kobold deity of war and mining",
      "Nonhuman", "LE",
      "War", "Gnome skull" },
};
