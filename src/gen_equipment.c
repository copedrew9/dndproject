...
const ItemData BOOK_ITEMS[] = {
    ...
    { "Blanket", BOOK_PHB, ITEM_GEAR,
      ...
      "", "", "",
      "" },
    { "Block of incense", BOOK_PHB, ITEM_GEAR,
      0, 0, 0, 0, 0, 0,
      "", "", "",
      "" },
    ...
    { "Book", BOOK_PHB, ITEM_GEAR,
      ...
      "", "", "",
      "" },
    { "Book of lore", BOOK_PHB, ITEM_GEAR,
      0, 50, 0, 0, 0, 0,
      "", "", "",
      "" },
    { "Bottle, glass", BOOK_PHB, ITEM_GEAR,
      200, 20, 0, 0, 0, 0,
      "", "", "",
      "" },
    ...
    { "Candle", BOOK_PHB, ITEM_GEAR,
      ...
      "", "", "",
      "" },
    { "Case, crossbow bolt", BOOK_PHB, ITEM_GEAR,
      100, 10, 0, 0, 0, 0,
      "", "", "",
      "" },
    { "Case, map or scroll", BOOK_PHB, ITEM_GEAR,
      100, 10, 0, 0, 0, 0,
      "", "", "",
      "" },
    ...
    { "Lantern, hooded", BOOK_PHB, ITEM_GEAR,
      ...
      "", "", "",
      "" },
    { "Little bag of sand", BOOK_PHB, ITEM_GEAR,
      0, 0, 0, 0, 0, 0,
      "", "", "",
      "" },
    ...
    { "Signet ring", BOOK_PHB, ITEM_GEAR,
      ...
      "", "", "",
      "" },
    { "Small knife", BOOK_PHB, ITEM_GEAR,
      0, 0, 0, 0, 0, 0,
      "", "", "",
      "" },
    { "Soap", BOOK_PHB, ITEM_GEAR,
      ...
      "", "", "",
      "" },
    { "String (10 feet)", BOOK_PHB, ITEM_GEAR,
      0, 0, 0, 0, 0, 0,
      "", "", "",
      "" },
    ...
    { "Dice set", BOOK_PHB, ITEM_TOOL,
      ...
      "", "", "",
      "" },
    { "Dragonchess set", BOOK_PHB, ITEM_TOOL,
      100, 5, 0, 0, 0, 0,
      "", "", "",
      "" },
    { "Playing card set", BOOK_PHB, ITEM_TOOL,
      ...
      "", "", "",
      "" },
    { "Three-Dragon Ante set", BOOK_PHB, ITEM_TOOL,
      100, 0, 0, 0, 0, 0,
      "", "", "",
      "" },
...
const PackItem PACK_ITEMS[] = {
    { "Burglar's pack", "Backpack", 1 },
    { "Burglar's pack", "Ball bearings (bag of 1,000)", 1 },
    { "Burglar's pack", "String (10 feet)", 1 },
    { "Burglar's pack", "Bell", 1 },
    { "Burglar's pack", "Candle", 5 },
    { "Burglar's pack", "Crowbar", 1 },
    { "Burglar's pack", "Hammer", 1 },
    { "Burglar's pack", "Piton", 10 },
    { "Burglar's pack", "Lantern, hooded", 1 },
    { "Burglar's pack", "Oil (flask)", 2 },
    { "Burglar's pack", "Rations (1 day)", 5 },
    { "Burglar's pack", "Tinderbox", 1 },
    { "Burglar's pack", "Waterskin", 1 },
    { "Burglar's pack", "Rope, hempen (50 feet)", 1 },
    { "Diplomat's pack", "Chest", 1 },
    { "Diplomat's pack", "Case, map or scroll", 2 },
    { "Diplomat's pack", "Clothes, fine", 1 },
    { "Diplomat's pack", "Ink (1 ounce bottle)", 1 },
    { "Diplomat's pack", "Ink pen", 1 },
    { "Diplomat's pack", "Lamp", 1 },
    { "Diplomat's pack", "Oil (flask)", 2 },
    { "Diplomat's pack", "Paper (one sheet)", 5 },
    { "Diplomat's pack", "Perfume (vial)", 1 },
    { "Diplomat's pack", "Sealing wax", 1 },
    { "Diplomat's pack", "Soap", 1 },
    { "Dungeoneer's pack", "Backpack", 1 },
    { "Dungeoneer's pack", "Crowbar", 1 },
    { "Dungeoneer's pack", "Hammer", 1 },
    { "Dungeoneer's pack", "Piton", 10 },
    { "Dungeoneer's pack", "Torch", 10 },
    { "Dungeoneer's pack", "Tinderbox", 1 },
    { "Dungeoneer's pack", "Rations (1 day)", 10 },
    { "Dungeoneer's pack", "Waterskin", 1 },
    { "Dungeoneer's pack", "Rope, hempen (50 feet)", 1 },
    { "Entertainer's pack", "Backpack", 1 },
    { "Entertainer's pack", "Bedroll", 1 },
    { "Entertainer's pack", "Clothes, costume", 2 },
    { "Entertainer's pack", "Candle", 5 },
    { "Entertainer's pack", "Rations (1 day)", 5 },
    { "Entertainer's pack", "Waterskin", 1 },
    { "Entertainer's pack", "Disguise kit", 1 },
    { "Explorer's pack", "Backpack", 1 },
    { "Explorer's pack", "Bedroll", 1 },
    { "Explorer's pack", "Mess kit", 1 },
    { "Explorer's pack", "Tinderbox", 1 },
    { "Explorer's pack", "Torch", 10 },
    { "Explorer's pack", "Rations (1 day)", 10 },
    { "Explorer's pack", "Waterskin", 1 },
    { "Explorer's pack", "Rope, hempen (50 feet)", 1 },
    { "Priest's pack", "Backpack", 1 },
    { "Priest's pack", "Blanket", 1 },
    { "Priest's pack", "Candle", 10 },
    { "Priest's pack", "Tinderbox", 1 },
    { "Priest's pack", "Alms box", 1 },
    { "Priest's pack", "Block of incense", 2 },
    { "Priest's pack", "Censer", 1 },
    { "Priest's pack", "Vestments", 1 },
    { "Priest's pack", "Rations (1 day)", 2 },
    { "Priest's pack", "Waterskin", 1 },
    { "Scholar's pack", "Backpack", 1 },
    { "Scholar's pack", "Book of lore", 1 },
    { "Scholar's pack", "Ink (1 ounce bottle)", 1 },
    { "Scholar's pack", "Ink pen", 1 },
    { "Scholar's pack", "Parchment (one sheet)", 10 },
    { "Scholar's pack", "Little bag of sand", 1 },
    { "Scholar's pack", "Small knife", 1 },
};
const int PACK_ITEM_COUNT =
    (int)(sizeof(PACK_ITEMS) / sizeof(PACK_ITEMS[0]));
...
const GemData GEMS[] = {
    { "Azurite", 10, "opaque mottled deep blue" },
    { "Banded agate", 10, "translucent striped brown, blue, white, or red" },
    { "Blue quartz", 10, "transparent pale blue" },
    { "Eye agate", 10, "translucent circles of gray, white, brown, blue, or green" },
    { "Hematite", 10, "opaque gray-black" },
    { "Lapis lazuli", 10, "opaque light and dark blue with yellow flecks" },
    { "Malachite", 10, "opaque striated light and dark green" },
    { "Moss agate", 10, "translucent pink or yellow-white with mossy gray or green "
      "markings" },
    { "Obsidian", 10, "opaque black" },
    { "Rhodochrosite", 10, "opaque light pink" },
    { "Tiger eye", 10, "translucent brown with golden center" },
    { "Turquoise", 10, "opaque light blue-green" },
    { "Bloodstone", 50, "opaque dark gray with red flecks" },
    { "Carnelian", 50, "opaque orange to red-brown" },
    { "Chalcedony", 50, "opaque white" },
    { "Chrysoprase", 50, "translucent green" },
    { "Citrine", 50, "transparent pale yellow-brown" },
    { "Jasper", 50, "opaque blue, black, or brown" },
    { "Moonstone", 50, "translucent white with pale blue glow" },
    { "Onyx", 50, "opaque bands of black and white, or pure black or white" },
    { "Quartz", 50, "transparent white, smoky gray, or yellow" },
    { "Sardonyx", 50, "opaque bands of red and white" },
    { "Star rose quartz", 50, "translucent rosy stone with white star-shaped center" },
    { "Zircon", 50, "transparent pale blue-green" },
    { "Amber", 100, "transparent watery gold to rich gold" },
    { "Amethyst", 100, "transparent deep purple" },
    { "Chrysoberyl", 100, "transparent yellow-green to pale green" },
    { "Coral", 100, "opaque crimson" },
    { "Garnet", 100, "transparent red, brown-green, or violet" },
    { "Jade", 100, "translucent light green, deep green, or white" },
    { "Jet", 100, "opaque deep black" },
    { "Pearl", 100, "opaque lustrous white, yellow, or pink" },
    { "Spinel", 100, "transparent red, red-brown, or deep green" },
    { "Tourmaline", 100, "transparent pale green, blue, brown, or red" },
    { "Alexandrite", 500, "transparent dark green" },
    { "Aquamarine", 500, "transparent pale blue-green" },
    { "Black pearl", 500, "opaque pure black" },
    { "Blue spinel", 500, "transparent deep blue" },
    { "Peridot", 500, "transparent rich olive green" },
    { "Topaz", 500, "transparent golden yellow" },
    { "Black opal", 1000, "translucent dark green with black mottling and golden flecks" },
    { "Blue sapphire", 1000, "transparent blue-white to medium blue" },
    { "Emerald", 1000, "transparent deep bright green" },
    { "Fire opal", 1000, "translucent fiery red" },
    { "Opal", 1000, "translucent pale blue with green and golden mottling" },
    { "Star ruby", 1000, "translucent ruby with white star-shaped center" },
    { "Star sapphire", 1000, "translucent blue sapphire with white star-shaped center" },
    { "Yellow sapphire", 1000, "transparent fiery yellow or yellow green" },
    { "Black sapphire", 5000, "translucent lustrous black with glowing highlights" },
    { "Diamond", 5000, "transparent blue-white, canary, pink, brown, or blue" },
    { "Jacinth", 5000, "transparent fiery orange" },
    { "Ruby", 5000, "transparent clear red to deep crimson" },
};
const int GEM_COUNT =
    (int)(sizeof(GEMS) / sizeof(GEMS[0]));
...
const MagicRule MAGIC_RULES[] = {
    ...
    { "Berserker Axe", .weapon = 1, .weapon_plus = 1 },
    { "Dagger of Venom", .weapon = 1, .weapon_plus = 1 },
    { "Defender", .weapon = 1, .weapon_plus = 3 },
    { "Dragon Slayer", .weapon = 1, .weapon_plus = 1 },
    { "Dwarven Thrower", .weapon = 1, .weapon_plus = 3 },
    { "Giant Slayer", .weapon = 1, .weapon_plus = 1 },
    { "Hammer of Thunderbolts", .weapon = 1, .weapon_plus = 1 },
    { "Holy Avenger", .weapon = 1, .weapon_plus = 3 },
    { "Luck Blade", .weapon = 1, .weapon_plus = 1 },
    { "Mace of Smiting", .weapon = 1, .weapon_plus = 1 },
    { "Nine Lives Stealer", .weapon = 1, .weapon_plus = 2 },
    { "Scimitar of Speed", .weapon = 1, .weapon_plus = 2 },
    { "Sun Blade", .weapon = 1, .weapon_plus = 2 },
    { "Vorpal Sword", .weapon = 1, .weapon_plus = 3 },
    { "Sword of Answering", .weapon = 1, .weapon_plus = 3 },
    { "Sword of Vengeance", .weapon = 1, .weapon_plus = 1 },
    { "Blackrazor", .weapon = 1, .weapon_plus = 3 },
    { "Wave", .weapon = 1, .weapon_plus = 3 },
    { "Whelm", .weapon = 1, .weapon_plus = 3 },
    { "Axe of the Dwarvish Lords", .weapon = 1, .weapon_plus = 3 },
    { "Moonblade", .weapon = 1, .weapon_plus = 1 },
    { "Staff of Striking", .weapon = 1, .weapon_plus = 3, .weapon_as = "Quarterstaff" },
    { "Staff of the Magi", .weapon = 1, .weapon_plus = 2, .weapon_as = "Quarterstaff" },
    { "Staff of the Woodlands", .weapon = 1, .weapon_plus = 2, .weapon_as = "Quarterstaff" },
    { "Staff of Thunder and Lightning", .weapon = 1, .weapon_plus = 2, .weapon_as = "Quarterstaff" },
    { "Rod of Lordly Might", .weapon = 1, .weapon_plus = 3, .weapon_as = "Mace" },
    { "Wand of Orcus", .weapon = 1, .weapon_plus = 3, .weapon_as = "Mace" },
    { "Sword of Kas", .weapon = 1, .weapon_plus = 3, .weapon_as = "Longsword" },
